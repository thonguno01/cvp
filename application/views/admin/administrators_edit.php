  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Sửa quản trị viên </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Enter name" value="<?= $check->name?>" require>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Email</label><span id="error_email"></span>
                    <input type="email" class="form-control" id="email" placeholder="Email" value="<?= $check->email?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Phone</label>
                    <input type="number" class="form-control" id="phone" placeholder="Phone" value="<?= $check->phone?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Password</label><span id="error_pass"></span>
                    <input type="password" class="form-control" id="password" placeholder="Bỏ trống mật khẩu để không cập nhật">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Quyền quản trị</label>
                    <select name="" id="administrators">
                        <option value="<?= $check->administrators?>" selected><?= $admin[$check->administrators]?></option>
                        <?php
                        for($i = 0; $i < 5; $i++){
                        ?>
                ...
                <div class="card-footer">
                  <button type="button" class="btn btn-primary" onclick="validate_edit_admin(<?= $check->id?>)">Submit</button>
                </div>
              </form>
            </div>
    </section>
