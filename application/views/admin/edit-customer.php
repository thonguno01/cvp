...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Nhập đủ họ và tên " value="<?= $customer['name'] ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="email">Email</label>
                    <input type="email" class="form-control" id="email" placeholder="Email" readonly value="<?= $customer['email'] ?>">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" id="phone" placeholder="Nhập vào bắt buộc là số ..." readonly value="<?= $customer['phone'] ?>">
                </div>
                ...
                <div class="custom-control custom-radio ">
                    <input type="radio" class="custom-control-input" id="male" name="gender" value="1" required <?php if ($customer['gender'] == 1) {
                                                                                                                    echo 'checked';
                                                                                                                } ?>>
                    <label class="custom-control-label" for="male">Male</label>
                </div>
                <div class="custom-control custom-radio mb-3">
                    <input type="radio" class="custom-control-input" id="felmale" name="gender" value="0" required <?php if ($customer['gender'] == 0) {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                    <label class="custom-control-label" for="felmale">Female</label>
                </div>
                <button type="button" onclick="edit(<?= $customer['id'] ?>)" class="btn btn-primary col-md-6">Chỉnh sửa </button>
                <!-- </form> -->
            </section>
            <!-- /.content -->
        </div>
    ...
    <script src="/script/admin/edit_customer.js"></script>
</body>
