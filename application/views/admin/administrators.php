    ...
    <section class="content">
        <div class="row">
          <form action="" method="post" style="width:100%">
            ...
            <?php
            if($check->administrators == 0){
            ?>
            <div class="col-md-6">
              <button type="button" onclick="them_quan_tri()" class="btn btn-primary pull-right add-user" id="popup-btn" >
      ...
      <div class="rowa">
        ...
        <thead>
          ...
          <th width="20%">Quyền quản trị</th>
          <th width="20%">Ngày tạo</th>
          <th width="5%">Xác thực</th>
        ...
        <tbody>
          ...
          if($time_start != '' && $time_end == ''){
            $sql = $this->Generals_model->notifi('admin',['created_at >=' => $time_start]);
          }
          elseif($time_start == '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('admin',['created_at <=' => $time_end]);
          }
          elseif($time_start != '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('admin',['created_at >=' => $time_start, 'created_at <=' => $time_end]);
          }
          else{
            $sql = $this->Generals_model->get_list_orderby('admin');
          }
         ...
         <tr>
            ...
            <td><?= $v["phone"]?></td>
            <?php 
            if($v["administrators"] == 0){
            ?>
            <td style="color: red; background: repeating-linear-gradient(45deg, black, transparent 100px);"><?= $admin[$v["administrators"]]?></td>
            <?php
            }
            else{
            ?>
            <td><?= $admin[$v["administrators"]]?></td>
            <?php
            }
            ?>
            <td><?= $v["created_at"]?></td>
            <td><input type="checkbox" <? if($v['authentic'] == 1) echo "checked"; ?>  onchange="update_auth(<?= $v['id']?>)"></td>
            <td>
...
<script>
  ...
  function them_quan_tri(){
      window.location = 'administrators_add'
  }
