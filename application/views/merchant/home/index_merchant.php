    ...
    <div class="body">
        ...
        <div class="content">
            <div class="tutorial_use">
                ...
                <div class="use_all">
                    ...
                    <div class="box1_use">
                        <div class="banner_use">
                            <a href="merchant/chi-tiet-<?php $slug = $data_index_2->title;
                    ...
                    <div class="box2_use">
                        ...
                        ?>
                                <div class="list_use">
                                    <div class="img_use">
                                        <a href="merchant/chi-tiet-<?php $slug = $v["title"];
                ...
                <div class="view_all"><a href="merchant/chi-tiet-<?php $slug = $data_index_2->title;
                                        echo   create_slug($slug); ?>-<?= $data_index_2->id ?>" target="blank">Xem tất cả</a></div>
            </div>
            <div class="news_merchant">
                ...
                <div class="news_merchant_all">
                    ...
                    <div class="box1_news_merchant">
                        <div class="banner_news_merchant">
                            <a href="merchant/chi-tiet-<?php $slug = $data_index_2_new->title;
                ...
                <div class="view_all"><a href="merchant/chi-tiet-<?php $slug = $data_index_2_new->title;
                                        echo   create_slug($slug); ?>-<?= $data_index_2_new->id ?>" target="blank">Xem tất cả</a></div>
            </div>
            <div class="question_al">
                ...
                <div class="news_question">
                    ...
                    <div class="box1_question">
                        <div class="banner_question">
                            <a href="merchant/chi-tiet-<?php $slug = $data_index_2_ques->title;
                ...
                <div class="view_all"><a href="merchant/chi-tiet-<?php $slug = $data_index_2_ques->title;
                                        echo   create_slug($slug); ?>-<?= $data_index_2_ques->id ?>" target="blank">Xem tất cả</a></div>
            </div>
            <div class="partner">
            ...
            <div class="tutorial">
                ...
                <div class="tu_content">
                    ...
                    <div class="question">
                        ...
                        <input class="input" type="text" placeholder="Họ và tên" value="">
                        <input class="input" type="text" placeholder="Email" value="" readonly>
