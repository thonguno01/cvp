                ...
                <div class="ban_text">
                    <div class="ban_text_1">
                        ...
                        <div class="gg_or_facebook">
                            ...
                            <div class="email">
                                <span class="title_email"><p>hoặc Đặng ký với Email</p></span>
                            </div>
                        </div>
                        <form action="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input">
                                    <input type="number" id="phone" placeholder="Nhập Số điện thoại" onblur="phone_error()">
                            ...
                            <button type="button" onclick="return form_validate();" class="button"> Đăng Kí</button>
                        </form>
                        <div class="__login">
                            <p>Bạn đã có tài khoản ? </p>
                            <a href="/merchant-login"> Đăng nhập</a>
                        </div>
                        <div class="license">
