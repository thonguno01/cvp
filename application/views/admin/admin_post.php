  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Quản lý bài viết của SALE</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin-index">Trang Chủ</a></li>
              <li class="breadcrumb-item active">Quản lý bài viết</li>
              <li class="breadcrumb-item active">Quản lý bài viết của SALE</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="row">
          <form action="" method="post" style="width:100%">
            ...
            <div class="col-md-6">
              <button type="button" onclick="them_bai_viet()" class="btn btn-primary pull-right add-user" id="popup-btn" >
      ...
      <div class="rowa">
        ...
        <tbody>
          ...
          if($time_start != '' && $time_end == ''){
            $sql = $this->Generals_model->notifi('posts_index_merchant',['created_at >=' => $time_start]);
          }
          elseif($time_start == '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('posts_index_merchant',['created_at >=' => $time_end]);
          }
          elseif($time_start != '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('posts_index_merchant',['created_at >=' => $time_start, 'created_at <=' => $time_end]);
          }
          else{
            $sql = $this->Generals_model->get_list_orderby('posts_index_merchant');
          }
         ...
         <tr>
            ...
            <td><?= $v["content"]?></td>
            <td>
                <img src="upload/admin/<?= $v["img"]?>" alt="">
            </td>
            <td><?= $type_post[$v["type_post"]]?></td>
            <td><?= $v["created_at"]?></td>
            ...
            <td>
            <a href="edit-post-sale-<?=$v['id']?>" class="btn btn-sm btn-success">
                    <i class="fas fa-edit"></i>
                </a>
            </td>
        </tr>
...
<script>
  ...
  function update_censorship(e,id){
    ...
    let checkcensorship = callAjax('/check-censorship-admin', 'post', data_json);
    if(checkcensorship.rs == true){
        alert(checkcensorship.msg)
    }
    }
    function them_bai_viet(){
      window.location = 'add-post-sale'
    }
</script>
</body>
</html>
