                    ...
                    <form action="">
                        ...
                        <div class="note-login">
                            ...
                            <div class="forgot-password">
                                <a href="/merchant-forgot-password">Quên mật khẩu ?</a>
                            </div>

                        </div>
                        <button type="button" onclick="return form_validate();" class="button">Đăng nhập</button>
                    </form>
                    <div class="__register">
                        <p>Bạn đã có tài khoản ? </p>
                        <a href="/merchant-register"> Đăng kí </a>
                    </div>
                    <div class="license">
