  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Danh sách khách hàng đăng ký lỗi</h1>
            <div>Danh sách quán ăn đăng ký từ web : <span class="param">2323</span></div>
            <div>Danh sách quán ăn đăng ký từ app : <span class="param">344</span></div>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin-index">Trang Chủ</a></li>
              <li class="breadcrumb-item active">Danh sách đăng ký lỗi</li>
              <li class="breadcrumb-item active">Danh sách khách hàng đăng ký lỗi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="rowa">
        ...
        <tbody>
          ...
          if($time_start != '' && $time_end == ''){
            $sql = $this->Generals_model->notifi('customer_error',['created_at >=' => $time_start]);
          }
          elseif($time_start == '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('customer_error',['created_at <=' => $time_end]);
          }
          elseif($time_start != '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('customer_error',['created_at >=' => $time_start, 'created_at <=' => $time_end]);
          }
          else{
            $sql = $this->Generals_model->get_list_orderby('customer_error');
          }
         ...
         <tr>
            ...
            <td><?= $v["created_at"]?></td>
            <td>
            <a href="register-for-errorer-<?=$v['id']?>" class="btn btn-sm btn-success">
                    <i class="fas fa-edit"></i>
                </a>
            </td>
        </tr>
