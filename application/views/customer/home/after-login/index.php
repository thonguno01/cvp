                ...
                <div class="box">
                    ...
                    <div class="box-item">
                        ...
                        <div class="action">
                            ...
                            <button class="wrap-button" <?php
                                                        if ($isLogin == 1) {
                                                            foreach ($fav_mer as $fav) {
                                                                if ($fav['merchant_id'] == $mechant['id'] && $fav['customer_id'] == $cus) {
                                                                    echo 'style="background: #EC5569"' . 'onclick="favouriteMerchant(this , ' . $mechant['id'] . ')"';
                                                                }
                                                            }
                                                        } else {
                                                            echo 'onclick="popupLogin()"';
                                                        }
                                                        ?>>
                                <div class="icon_like"></div>
                                <div class="text_like">Yêu thích</div>
                            </button>
                        </div>
                        <div class="address">
                        ...
                        <div class="button_like <?php

                                                if (isset($mechant['like'])) {
                                                    echo 'like-active';
                                                }  ?> " id="like-<?= $mechant['id'] ?>"><button type="submit" onclick="<?php if ($isLogin == 1) {
                    ...
                    <div class="boxpro_item">
                        ...
                        <div class="action_pro">
                            ...
                            <button <?php
                                    ...
                                    ?> onclick="favouriteMerchant(this , <?= $mechant['id'] ?>)">
