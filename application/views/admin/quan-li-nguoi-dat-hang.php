        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Danh sách Người đặt hàng</h1>
                            <div>Danh sách Khách hàng đăng ký từ web : <span class="param">2323</span></div>
                            <div>Danh sách Khách hàng đăng ký từ app : <span class="param">344</span></div>
                        </div>
                        <div class="col-sm-6">
            ...
            <section class="content">
                <div class="row mb-3">
                    <form action="" method="post" style="width:100%">
                        <div class="col-sm-12 col-md-6  d-flex flex-row mb-3">
                            <div class="col-md-3">
                                <input type="date" class="form-control form_search from-date" value="<?php if (!empty($time_start)) echo date('Y-m-d', $time_start); ?>" name="time_start" onchange='if(this.value != 0) { this.form.submit(); }'>
                            </div>
                            <div class="col-md-3">
                                <input type="date" class="form-control form_search from-date" value="<?php if (!empty($time_start)) echo  date('Y-m-d',  $time_end); ?>" name="time_end" onchange='if(this.value != 0) { this.form.submit(); }'>
                            </div>
                            <!-- <button type="submit" class="btn btn-primary  ml-3 mb-3" id="search" name="search">Tìm kiếm</button> -->
                        </div>
                    </form>
                </div>
                            ...
                            <div class="table-responsive">
                                <div class="col-sm-12 col-md-6">
                                    <div class="dt-buttons btn-group flex-wrap">
                                        <form action="xuat-excel-user-order" method="post">
                                            <button type="submit" class="btn btn-primary  mb-3" id="export" name="export">Xuất excel</button>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <table id="dataid" class="table table-striped table-bordered" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="15%">Tên khách hàng đặt</th>
                                            <th width="10%">Phone Đặt</th>
                                            <th width="15%">Tên khách hàng nhận</th>
                                            <th width="10%">Phone nhận </th>
                                            <th width="40%">Địa chỉ nhận hàng </th>
                                            <th width="40%">Thời gian đặt </th>
                                        </tr>
                                    </thead>
                                    <tbody>

                                        <?php
                                        foreach ($person_orders as $key => $value) {
                                        ?>
                                            <tr>
                                                <td><?= $key + 1 ?></td>
                                                <td><?= $value['code'] ?></td>
                                                <?php $address = $this->Generals_model->get_one_where_array_row('address_receive', ['id' => $value['addresss_id']]);
