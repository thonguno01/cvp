  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Đăng ký cho quán ăn đăng ký lỗi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin-index">Home</a></li>
              <li class="breadcrumb-item active">Quản lý đăng ký lỗi</li>
              <li class="breadcrumb-item active">Đăng ký cho quán ăn đăng ký lỗi</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <form action="">
            ...
            <div class="input">
                <button type="button" onclick="validate_merchant()">Thêm</button>
            </div>
        </form>
    </section>
  <!-- /.content-wrapper -->
