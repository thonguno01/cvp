  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Thêm quán ăn</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin-index">Home</a></li>
              <li class="breadcrumb-item active">Thêm quán ăn</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <form action="">
            <div class="input">
                ...
                <input type="text" id="name" placeholder="Nhập tên chủ quán"><span id="error_name"></span>
            </div>
            <div class="input">
                <span>Email </span>
                <input type="text" id="email" placeholder="Nhập Email"><span id="error_email"></span>
            </div>
            <div class="input">
                <span>Số điện thoại </span>
                <input type="number" id="phone" placeholder="Nhập SĐT"><span id="error_phone"></span>
            </div>
            <div class="input">
