        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Danh sách quán ăn</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="rowa">
        ...
        <tbody>
          ...
          if($time_start != '' && $time_end == ''){
            $sql = $this->Generals_model->notifi('merchant',['created_at >=' => $time_start]);
          }
          elseif($time_start == '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('merchant',['created_at >=' => $time_end]);
          }
          elseif($time_start != '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('merchant',['created_at >=' => $time_start, 'created_at <=' => $time_end]);
          }
          else{
            $sql = $this->Generals_model->get_list_orderby('merchant');
          }
         ...
         <tr>
            ...
            <td><?= $v["phone"]?></td>
            <td><?= $v["email"]?></td>
            <td><?= $v["name_merchant"]?></td>
            <td><?= $v["created_at"]?></td>
            <td><input type="checkbox" <? if($v['index'] == 1) echo "checked"; ?>  value="1"></td>
            <?php
                        if($v['from'] == 0)
                        {
                      ?>
                    ...
                    ?>
            <td>
            <a href="admin-edit-merchant-<?=$v['id']?>" class="btn btn-sm btn-success">
                    <i class="fas fa-edit"></i>
                </a>
            </td>
        </tr>
