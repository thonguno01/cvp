  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Danh sách quán ăn đăng ký lỗi</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Danh sách quán ăn đăng ký lỗi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="rowa">
        ...
        <tbody>
          ...
          if($time_start != '' && $time_end == ''){
            $sql = $this->Generals_model->notifi('merchant_error',['created_at >=' => $time_start]);
          }
          elseif($time_start == '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('merchant_error',['created_at <=' => $time_end]);
          }
          elseif($time_start != '' && $time_end != ''){
            $sql = $this->Generals_model->notifi('merchant_error',['created_at >=' => $time_start, 'created_at <=' => $time_end]);
          }
          else{
            $sql = $this->Generals_model->get_list_orderby('merchant_error');
          }
         ...
         <tr>
            ...
            <td><?= $v["created_at"]?></td>
            <td>
            <a href="register-for-merchant-<?=$v['id']?>" class="btn btn-sm btn-success">
                    <i class="fas fa-edit"></i>
                </a>
            </td>
        </tr>
