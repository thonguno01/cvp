                                ...
                                <table id="dataid" class="table table-striped table-bordered" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="15%">QUán ăn </th>
                                            <th width="20%">Địa chỉ nhận hàng </th>
                                            <th width="30%">Món ăn </th>
                                            <th width="8%">Thành tiền </th>
                                            <th width="8%">Khuyến mại</th>
                                            <th width="8%">Phí ship</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= number_format($order['total_before']) . 'đ' ?></td>
                                                <td><?= number_format($order['sale']) . 'đ' ?></td>
                                                <td><?= number_format($order['fee_ship']) . 'đ' ?></td>
                                                <td><?= number_format($order['total_after']) . 'đ' ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
