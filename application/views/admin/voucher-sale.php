                                ...
                                <table id="dataid" class="table table-striped table-bordered" style="width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        if ($time_start != '' && $time_end == '') {
                                            $sql = $this->Generals_model->notifi('voucher', ['created_at >=' => $time_start, 'from' => 1]);
                                        } elseif ($time_start == '' && $time_end != '') {
                                            $sql = $this->Generals_model->notifi('voucher', ['created_at <=' => $time_end, 'from' => 1]);
                                        } elseif ($time_start != '' && $time_end != '') {
                                            $sql = $this->Generals_model->notifi('voucher', ['created_at >=' => $time_start, 'created_at <=' => $time_end, 'from' => 1]);
                                        } else {
                                            $sql = $this->Generals_model->notifi('voucher', ['from' => 1]);
                                        }
