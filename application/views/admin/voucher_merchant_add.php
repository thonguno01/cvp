...
<div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Thêm mới Voucher cho cửa hàng</h1>
                        </div>
            ...
            <section class="content col-md-9">
                <form action="voucher-sale-addNew" method="POST">
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" name="code" id="name" placeholder="ABC726611">
                    </div>
                    <div class="form-group ">
                        <label for="name">Dành cho quán ăn </label>
                        <select class="form-control form-select" name="" id="">
                        <?php
                        $data_arr_mer =  $this->Generals_model->get_list('merchant');
                        foreach($data_arr_mer as $key => $v){
                        ?>
                        <option value="<?= $v["id"]?>"><?= $v["name_merchant"]?> - <?= $v["id"]?></option>
                        <?php
                        }
                        ?>
                        </select>
                    ...
                    <label for="number_tiket">Thứ áp dụng voucher</label>
                    ...
                    <div class="form-row">
                        <div class=" mb-3 col-md-6">
                            <label for="gio_bd">Ngày bắt đầu </label>
                            <input class="form-control" type="date">
                        </div>
                        <div class=" mb-3 col-md-6">
                            <label for="gio_kt">Ngày kết thúc</label>
                            <input class="form-control" type="date">
                        </div>
                    </div>
                    <div class="form-row">
