              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="authentic">
                    <label class="form-check-label" for="exampleCheck1">Yêu cầu xác thực ?</label>
                  </div>
                </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="button" class="btn btn-primary" onclick="validate_add_admin()">Submit</button>
                </div>
              </form>
            </div>
    </section>
