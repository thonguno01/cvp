  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Sửa bài đăng cho Sale</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin-index">Trang Chủ</a></li>
              <li class="breadcrumb-item active">Quản lý bài viết</li>
              <li class="breadcrumb-item active">Sửa bài đăng cho Sale</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <form id="quickForm" name="a">
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="email" name="title" class="form-control" id="title" placeholder="Tiêu đề tin" value="<?= $check->title?>">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Loại tin</label>
                <select class="form-control" name="" id="type">
                  <option value="<?=$check->type_post?>" selected><?=$type_post[$check->type_post]?></option>
                    <?php 
                    for($i = 1; $i < 4; $i++){
                    ?>
            ...
            <div class="form-group">
                ...
                <input class="btn btn-success col fileinput-button" type="file" id="imageFile"  accept=".jpg,.jpeg,.png,.gif" readonly>
            </div>
            
            <div class="form-group">
                <img class="selected_img" src="/upload/admin/<?= $check->img?>" alt="">
        ...
        <div class="card-footer">
            <button type="button" class="btn btn-primary" onclick="validate(<?= $check->id?>)">Submit</button>
        </div>
    </form>
...
<script>
  ...
  function validate(id){
      ...
      if(check == true){
        ...
        let out = callAjax('/edit-post-sale/php', 'post', data_json);
        if (out.rs == true) {
            alert(out.msg);
