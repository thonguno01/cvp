...
function form_validate() {
    ...
    if (flag == true) {
        ...
        let message = callAjax('customer-change-password-success', 'post', data_json);
        if (message.link != '') {
...
$('#veryfi-code').blur(() => {
    ...
    let checkOTP = callAjax('/customer-change-password/checkOtp', 'post', data_json);
    if (checkOTP.message != '') {
...
// Gửi lại mã xác thực 
$('#new-otp').click(() => {
    let reSendOtp = callAjax('customer-change-password/resendOtp', 'post', '');
